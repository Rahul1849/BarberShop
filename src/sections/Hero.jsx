  ...
  return (
    <>
      ...
      >
        ...
        >
          <h1 data-aos="zoom-in" className="text-4xl text-black font-semibold">
            WELCOME TO THE
          </h1>
          ...
          <h1
            data-aos="zoom-in"
            className=" italic text-4xl text-black font-bold"
          >
            {" "}
          ...
          >
            ...
            >
              ...
              <h1 className="text-xl text-gray-800 font-semibold">
                Phulwari Sharif, Near AIIMS Patna, Bihar
              </h1>
            </div>
            <div
              id="icon-box"
            ...
            >
              ...
              <h1 className="text-xl text-gray-800 font-semibold">
                +91 123 456 7890 / +91 456 789 1230
              </h1>
            </div>
            <div
              id="icon-box"
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 justify-center items-start w-full md:px-[120px] px-10 py-10 gap-10">
        ...
        >
          <img
            ...
            className="size-16 transform hover:scale-110 transition-transform duration-300 cursor-pointer"
          />
          <h1 className="text-2xl text-black font-semibold">Layered Cut</h1>
          <button className="px-10 py-3 bg-black text-white text-md font-semibold rounded-xl hover:bg-themeyellow hover:text-black cursor-pointer">
            MORE
          </button>
        </div>
        ...
        >
          <img
            ...
            className="size-16 transform hover:scale-110 transition-transform duration-300 cursor-pointer"
          />
          <h1 className="text-2xl text-black font-semibold">Buzz Cut</h1>
          <button className="px-10 py-3 bg-black text-white text-md font-semibold rounded-xl hover:bg-themeyellow hover:text-black cursor-pointer">
            MORE
          </button>
        </div>
        ...
        >
          <img
            ...
            className="size-16 transform hover:scale-110 transition-transform duration-300 cursor-pointer"
          />
          <h1 className="text-2xl text-black font-semibold">Blunt Cut</h1>
          <button className="px-10 py-3 bg-black text-white text-md font-semibold rounded-xl hover:bg-themeyellow hover:text-black cursor-pointer">
            MORE
          </button>
        </div>
